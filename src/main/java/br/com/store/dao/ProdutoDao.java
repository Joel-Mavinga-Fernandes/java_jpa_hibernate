...
public class ProdutoDao {
	...
	// Filtar por varios parametros com criteria builder
	public List<Produto> findByParametersWhithCriteria(String nome, BigDecimal preco, LocalDate dataCadastro){
